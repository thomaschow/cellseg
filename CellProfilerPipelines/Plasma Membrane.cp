...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:False|notes:\x5B\'Load desired images from folder.\'\x5D]
    ...
    Input image file location:Elsewhere...\x7CC\x3A\\Users\\Thomas Chow\\Documents\\My Box Files\\iGEM
    ...
    Image count:1
    Text that these images have in common (case-sensitive):1pre.zvi
...
Morph:[module_num:10|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
IdentifyPrimaryObjects:[module_num:16|svn_version:\'10826\'|variable_revision_number:8|show_window:True|notes:\x5B\x5D]
...
IdentifyPrimaryObjects:[module_num:17|svn_version:\'10826\'|variable_revision_number:8|show_window:True|notes:\x5B\x5D]
...
MeasureObjectIntensity:[module_num:20|svn_version:\'10816\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:1
    Select an image to measure:Green
    Select objects to measure:PlasmaMembranesGreen

MeasureObjectIntensity:[module_num:21|svn_version:\'10816\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:1
...
FilterObjects:[module_num:23|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    Name the output objects:FilteredPMBlue
...
FilterObjects:[module_num:24|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    Name the output objects:FilteredPMGreen
...
FilterObjects:[module_num:25|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    Name the output objects:FilteredPMRed
...
ConvertObjectsToImage:[module_num:26|svn_version:\'10807\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select the input objects:FilteredPMBlue
    Name the output image:BlueChannel
    Select the color type:Color
    Select the colormap:Default

ConvertObjectsToImage:[module_num:27|svn_version:\'10807\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select the input objects:FilteredPMGreen
    Name the output image:GreenChannel
    Select the color type:Color
    Select the colormap:Default

MeasureObjectSizeShape:[module_num:28|svn_version:\'1\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select objects to measure:FilteredPMBlue
    Select objects to measure:FilteredPMGreen
    Select objects to measure:FilteredPMRed
    Calculate the Zernike features?:No

ExportToSpreadsheet:[module_num:29|svn_version:\'10880\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    ...
    File name:DATA.csv
    Use the object name for the file name?:Yes
    Data to export:FilteredPMRed
    Combine these object measurements with those of the previous object?:No
    File name:DATA.csv
    Use the object name for the file name?:Yes
    Data to export:FilteredPMBlue
    Combine these object measurements with those of the previous object?:No
    File name:DATA.csv
    Use the object name for the file name?:Yes
    Data to export:FilteredPMGreen
    Combine these object measurements with those of the previous object?:No
    File name:DATA.csv
    Use the object name for the file name?:Yes
...
SaveImages:[module_num:30|svn_version:\'10822\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    ...
    Select the image to save:BlueChannel
    Select the objects to save:FilteredPMBlue
    Select the module display window to save:None
    Select method for constructing file names:From image filename
    Select image name for file prefix:Image
    Enter single file name:11preB
    Do you want to add a suffix to the image file name?:Yes
    Text to append to the image name:B
    Select file format to use:png
    Output file location:Elsewhere...\x7CC\x3A\\\\Users\\\\Thomas Chow\\\\Documents\\\\My Box Files\\\\iGEM\\\\Automation\\\\PM_library_check\\\\PM 2
    Image bit depth:8
...
SaveImages:[module_num:31|svn_version:\'10822\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    Select the type of image to save:Image
    Select the image to save:GreenChannel
    Select the objects to save:FilteredPMGreen
    Select the module display window to save:None
    Select method for constructing file names:From image filename
    Select image name for file prefix:Image
    Enter single file name:11preG
    Do you want to add a suffix to the image file name?:Yes
    Text to append to the image name:G
    Select file format to use:png
    Output file location:Elsewhere...\x7CC\x3A\\\\Users\\\\Thomas Chow\\\\Documents\\\\My Box Files\\\\iGEM\\\\Automation\\\\PM_library_check\\\\PM 2
    Image bit depth:8
    Overwrite existing files without warning?:No
