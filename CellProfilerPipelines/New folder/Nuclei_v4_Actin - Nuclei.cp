...
ColorToGray:[module_num:4|svn_version:\'10318\'|variable_revision_number:2|show_window:False|notes:\x5B\'Extract the DIC channel.\'\x5D]
    Select the input image:Image
    Conversion method:Combine
    Image type\x3A:Channels
...
EnhanceEdges:[module_num:5|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\'Find the edges of the cells, using the Canny edge detection function. This is a very sensitive method, and will detect weak edges, a common occurence in non-fluorescent images.\'\x5D]
...
RescaleIntensity:[module_num:6|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescale intensity of DIC image.\'\x5D]
...
Morph:[module_num:7|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\'Dilate and erode the enhanced DIC image, to fill in the holes within the detected edges. This magnifies the intensity of the whole cell for downstream processing.\'\x5D]
...
IdentifyPrimaryObjects:[module_num:8|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B\'Identify the high intensity blobs produced by the dilation/erode iterations. \'\x5D]
...
RescaleIntensity:[module_num:9|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescale red channel.\'\x5D]
...
RescaleIntensity:[module_num:10|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescale green channel.\'\x5D]
...
RescaleIntensity:[module_num:11|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescale blue channel.\'\x5D]
...
MaskImage:[module_num:12|svn_version:\'10428\'|variable_revision_number:3|show_window:False|notes:\x5B\'Using the identified cells found in the DIC image, set the intensity of all pixels outside of the identified cells to zero. \'\x5D]
...
MaskImage:[module_num:13|svn_version:\'10428\'|variable_revision_number:3|show_window:False|notes:\x5B\'Using the identified cells found in the DIC image, set the intensity of all pixels outside of the identified cells to zero. \'\x5D]
...
MaskImage:[module_num:14|svn_version:\'10428\'|variable_revision_number:3|show_window:False|notes:\x5B\'Using the identified cells found in the DIC image, set the intensity of all pixels outside of the identified cells to zero. \'\x5D]
...
Morph:[module_num:18|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:ConnectedGreen
    Name the output image:SeparatedGreen
    Select the operation to perform:open
    Number of times to repeat operation:Forever
    Repetition number:2
    Scale:3

Morph:[module_num:19|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:ConnectedRed
    Name the output image:SeparatedRed
    Select the operation to perform:open
    Number of times to repeat operation:Forever
    Repetition number:2
    Scale:3

Morph:[module_num:20|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:ConnectedBlue
    Name the output image:SeparatedBlue
    Select the operation to perform:open
    Number of times to repeat operation:Forever
    Repetition number:2
    Scale:3

IdentifyPrimaryObjects:[module_num:21|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B\x5D]
    Select the input image:SeparatedRed
    ...
    Threshold correction factor:1
    Lower and upper bounds on threshold:0.0,0.375
    Approximate fraction of image covered by objects?:.005
...
IdentifyPrimaryObjects:[module_num:22|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B\x5D]
    Select the input image:SeparatedGreen
...
IdentifyPrimaryObjects:[module_num:23|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B\x5D]
    Select the input image:SeparatedBlue
...
FilterObjects:[module_num:32|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
...
FilterObjects:[module_num:33|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
...
RelateObjects:[module_num:34|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
RelateObjects:[module_num:35|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input child objects:FilteredGreen
    Select the input parent objects:Cells
    Calculate distances?:Both
    Calculate per-parent means for all child measurements?:Yes
    Calculate distances to other parents?:No
...
RelateObjects:[module_num:36|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input child objects:FilteredBlue
    Select the input parent objects:Cells
    Calculate distances?:Both
    Calculate per-parent means for all child measurements?:Yes
    Calculate distances to other parents?:No
...
MeasureObjectIntensity:[module_num:37|svn_version:\'10816\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:1
    Select an image to measure:RescaledBlue
    Select objects to measure:FilteredBlue

MeasureObjectIntensity:[module_num:38|svn_version:\'10816\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:1
    Select an image to measure:RescaledGreen
    Select objects to measure:FilteredGreen

MeasureObjectIntensity:[module_num:39|svn_version:\'10816\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:1
    Select an image to measure:RescaledRed
    Select objects to measure:FilteredRed

MeasureObjectSizeShape:[module_num:40|svn_version:\'1\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select objects to measure:FilteredGreen
    Calculate the Zernike features?:No

MeasureObjectSizeShape:[module_num:41|svn_version:\'1\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select objects to measure:FilteredBlue
    Calculate the Zernike features?:No

MeasureObjectSizeShape:[module_num:42|svn_version:\'1\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select objects to measure:FilteredRed
    Calculate the Zernike features?:No

ExportToSpreadsheet:[module_num:43|svn_version:\'10880\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
